      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-dark fs-3">DATA ABSENSI PEGAWAI</h5>
            <hr>
            <table class="table caption-top">                  
            <caption>
            <?php
              include "koneksi_absensi.php";
              $jumlah = mysqli_query($koneksi, "SELECT COUNT(nip) as jumlahData FROM data_absensi");
            ...
            <tbody>
              <?php
                $query = mysqli_query($koneksi, "SELECT * from data_absensi");
              ...
              <tr>
                ...
                <td class="text-center"><?php echo $data['ket_absensi']; ?> </td>
              </tr>
              <?php 
                  }
              ?>
              ...
              <div>                            
                <a href="proses-reset_absensi.php"> 
                  <button class="btn btn-primary btn-sm float-end" aria-pressed="true" onclick="return confirm('Apakah Anda yakin ingin mereset data absensi?')">Reset Data Absensi</button>
                </a>
              </div>
          </div>
        </div>
